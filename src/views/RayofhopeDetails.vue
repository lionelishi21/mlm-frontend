                ...
                <div class="col-xl-3 col-lg-6 col-md-5 col-sm-12 layout-top-spacing">
                    ...
                    <div class="user-profile">
                        <div class="widget-content widget-content-area">
                            <div class="text-center user-info">
                                ...
                                <p class="">{{getHopeDetails.name}}</p>
                                <p class=""><small>{{getHopeDetails.email}}</small></p>
                            </div>
                    ...
                    <div class="widget widget-card-four" >
                        <div class="w-content text-center">
                           <h3> {{getHopeDetails.percentage.status}}</h3>
                        </div>
                        <radial-component :sales="getHopeDetails.percentage.position"></radial-component>
                    </div>
                </div>
                    ...
                    <div class="bio layout-spacing ">
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="bio-skill-box">
                                ...
                                <div class="row">
<!--                                    <pre>{{getHopeDetails}}</pre>-->
                                    <div class="col-md-6" v-for="af in getHopeDetails.members">
                                        ...
                                        <div class="row mt-3" v-if="af.children">
                                            <div class="col-md-6" v-for="child in af.children">
                                                <div class="card">
    ...
    export default {
        ...
        methods: {
            ...
            init() {
                ...
                this.$store.dispatch('FETCH_RAYOFHOPE_DETAILS', affiliateId)
            },
