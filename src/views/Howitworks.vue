...
<!-- 	<section class="page-header page-header-classic page-header-md">
	...
	<div class="container pb-1" style="padding-top: 8.5%;  font-family: Arial, Helvetica, sans-serif;">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="overflow-hidden">
					...
					<p class="lead mb-0 appear-animation mt-3" data-appear-animation="maskUp" data-appear-animation-delay="200">
						Please First Note, that this is NOT an MLM, Net-Work-Marketing, or a Get Rich
						Quick Community. The MCC Online Community gives each Affiliate/Member, the unique opportunity of receiving Community Shared Cash Bonuses based on the
						Total of Each Members Personal Group Sales Volume.
		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<h5> BRONZE Affiliate</h5>
					<p class="text-dark text-5">
						When your personal group has a total of 12 eBook sales,
						you will receive a Cash Bonus of: $100
					</p>

					<h5>SILVER Affiliate</h5>
					<p class="text-dark text-5">
						When your personal group has total of 36 eBook sales,
						you will receive a Cash Bonus of: $600
					</p>

					<h5>GOLD Affiliate</h5>
					<p class="text-dark text-5 text-center">
						When your personal group has total of 108 eBook sales,
						you will receive a Cash Bonus of: $3,800
					</p>

					<h5>RUBY Affiliate</h5>
					<p class="text-dark text-5 text-center">
						<u>RUBY Affiliate</u>
						<br>
						When your personal group has total of 324 eBook sales,
						you will receive a Cash Bonus of: $22,000
					</p>

					<h4>DIAMOND Affiliate</h4>
					<p class="text-dark text-5 text-center">


						<br>
						When your personal group has a total of 972 eBook sales,
						you will receive a Cash Bonus of over $400,000 - which repeats each time your
						Diamond Group Affiliates has a total of 12 new eBook sales each!
					</p>
			...
			<div class="row">
				<div class="col-md-12 text-center mt-5">
					...
					<p class="text-dark text-5">Each Booster Package will enter you into MCC’S
						Worldwide Cooperative Marketing Campaign
					...
					<p class="text-dark text-5">Your Own Personal Self-Help eBook (22-yrs in the making)
						...
						“Shiaqga” 1- 2oz. & 1- 4oz. bottles (includes free S&H
						And More!
