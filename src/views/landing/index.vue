...
<div class="body">
	...
	<section id="home" class="section section-with-shape-divider custom-bg-color-3 border-0 pt-0 m-0">
		...
		<div class="custom-section-svg pt-5 pb-5 pb-md-0 mb-5 mb-md-0">
			<div class="custom-section-svg-background appear-animation"
				 data-appear-animation="fadeIn" data-appear-animation-delay="2300"
				 style="background-image: url(img/demos/startup-agency/backgrounds/morphing-bg-1.jpg);
...
<!--							</linearGradient>-->
				...
				<linearGradient id="gradient_SVG_3_" class="" style="color:green;" gradientUnits="userSpaceOnUse" x1="1557.4893" y1="663.6315" x2="1192.9751" y2="299.1174">
								<stop  offset="3.745963e-03" style="stop-color:green"/>
					<stop  offset="1" style="stop-color:green"/>
							</linearGradient>
				<g>
								<g>
			...
			<div class="container mt-5 pt-5">
				<div class="row align-items-center pt-5 mt-5 mt-lg-0 pt-lg-0">
					<div class="col-lg-10">
						<h1 class="font-weight-bold text-12 mb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200"> MAJESTIC CARES COMMUNITY - MCC</h1>
						<h2 class="font-weight-medium text-9 mb-3 pb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1400">A SIMPLE ACT OF CARING</h2>
						<p class="custom-font-secondary custom-font-size-1 mb-4 pb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1600">Caring Creates An Everlasting Ripple Effect! Receive Cash Bonuses For Any Worthwhile Purpose <br>And Transform Your Life As Well As The Lives of Others With a Simple Act of Caring And Sharing!</p>
						<a href="#" class="btn btn-gradient text-3 font-weight-bold px-5 py-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1800">Get Started</a>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- Section One -->
	<section class="section section-no-border section-angled m-0" style="background: white;">
	...
	<!-- Section Three -->
	<section id="support" class="section bg-light border-0 m-0 position-relative z-index-3 pt- mt-5" style="background: white;">
